  ...
  return (
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <h3 className=" font-semibold">Sunday School Exam</h3>
              ...
              {exams.length > 0 ? (
                exams.map((exam, idx) => (
                  <tr key={exam._id} className="border-b">
                    ...
                    <td className="p-2">{new Date(exam.examDate).toLocaleDateString()}</td>
                    <td className="p-2">{exam.examcenter}</td>
                    <td className="p-2">{new Date(exam.registerBefore).toLocaleDateString()}</td>
                    ...
                    <td className="p-2 text-center">
                      <div className="flex items-center justify-center gap-3">
                        <FaEye
                          ...
                          onClick={() => navigate(`/admin/exam/view/${exam._id}`)}
                        />
                        ...
                        <CiEdit
                          ...
                          size={20}
                          className="text-lavender--600 cursor-pointer"
                          onClick={() => navigate(`/admin/exam/editsundaysclexam/${exam._id}`)}
                        />
                      </div>
                    </td>
                  </tr>
