...
export const Studentauction = () => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      // ✅ Force toast to re-render every time (even with same message)
      ...
      // Force toast re-render for failure too
      setResponse({ status: null, message: "" });
      setTimeout(() => {
        setResponse({
          status: "Failed",
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      {...register("buyerPhone", { required: "Buyer Phone is required" })}
                    />
                    {errors.buyerPhone && <p className="text-sm text-red-500">{errors.buyerPhone.message}</p>}
                  </div>
                </div>
              )}
            </div>
