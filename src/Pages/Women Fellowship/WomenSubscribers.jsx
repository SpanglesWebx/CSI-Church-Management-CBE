...
export const WomenSubscribers = () => {
  ...
  const fetchWomenSubscribers = async () => {
    try {
      setLoading(true);

      const res = await axios.get(`${URL}/women-subscribers`, {
        params: {
          search: searchQuery,
          page: CurrentPage,
          limit: rowsPerPage,
          ...
          <table className="w-full text-sm text-gray-500">
            ...
            <tbody className="text-center">
              {loading ? (
                ...
                <tr>
                  <td colSpan="6" className="p-4">No Women Subscribers Found</td>
                </tr>
              ) : (
