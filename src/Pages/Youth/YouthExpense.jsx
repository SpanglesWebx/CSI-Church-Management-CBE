...
export const YouthExpense = () => {
  ...
  // Fetch Youth Fellowship expenses
  const fetchExpenses = async () => {
    try {
      const res = await axios.get(`${URL}/youthfellow-expenses`, {
    ...
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <div className="flex items-center justify-between p-4">
          <h1 className="text-lg font-semibold">Youth Fellowship Expense</h1>
                  ...
                  <div className="relative bg-white rounded-lg shadow">
                    ...
                    <div className="p-4 text-center md:p-5">
                      ...
                      <button
                        onClick={async () => {
                          try {
                            await axios.put(`${URL}/youthfellow-expenses/${selectedExpense._id}`, { approval_status: statusAction }, { headers: { Authorization: token } });
