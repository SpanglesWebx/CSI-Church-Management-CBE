  ...
  const fetchAuctions = async () => {
    try {
      const res = await axios.get(
        `${URL}/men-auctions/report/by-buyer?search=${search}&page=${CurrentPage}&limit=5`,
...
const handlePayment = async (auctionId) => {
  ...
  try {
    ...
    const res = await axios.get(`${URL}/men-auctions/report/by-buyer`, {
      headers: { Authorization: token },
    ...
    <div className="relative h-auto  w-full bg-gray-100">
      <div className="p-6 bg-white rounded-lg shadow-md">
        <div className="flex items-center justify-between p-4">
            <h2 className="text-2xl font-semibold mb-4">Men Auction Reports</h2>
            <div className="">
                        <label
