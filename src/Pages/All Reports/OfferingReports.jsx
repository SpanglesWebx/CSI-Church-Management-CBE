  ...
  return (
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <h4 className=" font-semibold">Offering Reports</h4>
        <div className="flex flex-col items-center justify-between">
          <div className="flex flex-wrap items-center p-4 space-x-3 space-y-3 lg:space-y-0 lg:space-x-3">
            ...
            <input
              ...
              className="block py-1 text-sm text-gray-900 rounded w-30 px-3 bg-gray-50 
            ...
            <div className="">
              ...
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="block py-1 text-sm text-gray-900 rounded w-30 ps-8 bg-gray-50 focus:ring-lavender--600 focus:border-lavender--600 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-lavender--600 dark:focus:border-lavender--600"
            ...
            <div className='flex flex-wrap items-center  lg:space-x-3'>
              ...
              <select
                ...
                className="block py-1 text-sm text-gray-900 rounded w-20 px-3 bg-gray-50 focus:ring-lavender--600 focus:border-lavender--600"
              >
