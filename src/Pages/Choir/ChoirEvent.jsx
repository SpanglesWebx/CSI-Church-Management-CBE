...
export const ChoirEvent = () => {
  ...
  const fetchEvents = async () => {
    try {
      const res = await axios.get(`${URL}/choir-members/all`, {
  ...
  const fetchPrizes = async () => {
    try {
      const res = await axios.get(`${URL}/choir-members/prizes/list`, {
        headers: { Authorization: token },
      });
  ...
  return (
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        ...
        <h1 className="text-lg font-semibold">Choir Events</h1>
        ...
        <div className="flex items-center justify-between p-4">
          ...
          <div className="flex gap-3">
            ...
            <button
              onClick={() => navigate("/admin/choir-addevent")}
              className="flex items-center gap-2 px-5 py-2 text-white bg-lavender--600 rounded-lg"
            >
              <FaPlus /> New Event
            </button>
                  ...
                  <td className="p-2 text-center">
                    <div className="flex items-center justify-center gap-3">
                      ...
                      <FaEye
                        ...
                        onClick={() =>
                          navigate(`/admin/choir/event/view/${event._id}`)
                        }
                      />
                      ...
                      <CiEdit
                        ...
                        className="text-lavender--600 cursor-pointer"
                        onClick={() =>
                          navigate(`/admin/choir/event/edit/${event._id}`)
                        }
                      />
                      ...
                      <FaPlus
                        ...
                        className="text-lavender--600 cursor-pointer"
                        onClick={() =>
                          navigate(`/admin/choir-addparticipants`, {
                            state: { event },
                          })
                        }
                      />
