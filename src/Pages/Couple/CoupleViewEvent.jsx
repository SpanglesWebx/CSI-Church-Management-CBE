...
export const CoupleViewEvent = () => {
  ...
  const fetchEvent = async () => {
    try {
      const res = await axios.get(`${URL}/couple-events/event/${eventId}`, {
  ...
  return (
    <>
      ...
      <div className="p-5 bg-white rounded ">
        ...
        {(event.coupleCompetitions || []).map((comp) => {
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                await axios.put(
                  `${URL}/couple-events/prizes/update`,
                  {
          ...
          <button
            ...
            onClick={async () => {
              ...
              try {
                ...
                await axios.put(
                  `${URL}/couple-events/participants/update`,
                  {
                    eventId: selectedCompetition.eventId,
                    competitionId: selectedCompetition.competition._id,
