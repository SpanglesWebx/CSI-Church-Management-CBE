...
export const CoupleExpense = () => {
  ...
  // Fetch Couple expenses
  const fetchExpenses = async () => {
    try {
      const res = await axios.get(`${URL}/couplefellow-expenses`, {
    ...
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <div className="flex items-center justify-between p-4">
          <h1 className="text-lg font-semibold">Couple Expense</h1>
          <div className="">
                ...
                expenses.map((exp, index) => (
                  <tr key={exp._id} className="border-t">
                    ...
                    <td className="p-2 text-center mx-auto">
                      <FaEye title='View' size={18} className="text-blue-600 cursor-pointer mx-auto" onClick={() => { setSelectedExpense(exp); setIsModalOpen(true); }} />
                    </td>
                  </tr>
                ))
              ) : (
                  ...
                  <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 text-center md:p-5">
                      ...
                      <button
                        onClick={async () => {
                          try {
                            await axios.put(`${URL}/couplefellow-expenses/${selectedExpense._id}`, { approval_status: statusAction }, { headers: { Authorization: token } });
