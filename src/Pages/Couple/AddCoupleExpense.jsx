...
export const AddCoupleExpense = () => {
    ...
    // 🔄 Debounced search logic (same as men, no change)
    ...
    // 🔄 API endpoints updated from men → couple
    ...
    const handleSave = async () => {
        ...
        try {
            await axios.post(`${URL}/couplefellow-expenses/add`, payload, { headers: { Authorization: token } });
    ...
    const handlePayExpense = async (expenseId, formData) => {
        try {
            const res = await axios.put(`${URL}/couplefellow-expenses/pay/${expenseId}`, formData, {
                headers: { Authorization: token },
            });
