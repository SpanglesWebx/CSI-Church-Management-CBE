...
export const WomenOpenBal = () => {
  ...
  const fetchOpeningBalances = async () => {
    const res = await axios.get(`${URL}/women-opening-balance/list`, {
      headers: { Authorization: token },
      params: {
        page: CurrentPage,
        limit: rowsPerPage,
  ...
  return (
    <>
      <div className="p-3 mx-1 mt-3 bg-white shadow-md rounded-[10px]">
        <h1 className="text-lg font-semibold">Women Opening Balance</h1>
