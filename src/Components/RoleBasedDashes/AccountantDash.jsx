...
export const AccountantDash = () => {
  ...
  const fetchFamilyCount = async () => {
    const res = await axios.get(`${URL}/dashboard/accountant/family-count`, {
      headers: {
        Authorization: token,
      },
    });
  ...
  const fetchMemberCount = async () => {
    const res = await axios.get(`${URL}/dashboard/accountant/member-count`, {
  ...
  const fetchSubscribedMemberCount = async () => {
    const res = await axios.get(`${URL}/dashboard/accountant/member-subscribed/count`, {
      headers: {
        Authorization: token,
      },
    });
  ...
  const fetchGeneralFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/general-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchCemeteryFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/cemetery-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchCemeteryBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/cemetery-balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchWomenFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/women-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchWomenBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/accountant/women-balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
