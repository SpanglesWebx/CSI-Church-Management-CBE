...
export const ChurchOfficeWorkerDash = () => {
  ...
  const fetchFamilyCount = async () => {
    const res = await axios.get(`${URL}/dashboard/ChurchOfficeWorker/family-count`, {
      headers: {
        Authorization: token,
      },
    });
  ...
  const fetchMemberCount = async () => {
    const res = await axios.get(`${URL}/dashboard/ChurchOfficeWorker/member-count`, {
  ...
  const fetchSubscribedMemberCount = async () => {
    const res = await axios.get(`${URL}/dashboard/ChurchOfficeWorker/member-subscribed/count`, {
      headers: {
        Authorization: token,
      },
    });
  ...
  const fetchGeneralFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/general-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchCemeteryFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/cemetery-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchCemeteryBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/cemetery-balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchWomenFund = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/women-fund/today`,
      {
        headers: { Authorization: token }
      }
    );
  ...
  const fetchWomenBalanceSummary = async () => {
    const res = await axios.get(
      `${URL}/dashboard/ChurchOfficeWorker/women-balance-summary`,
      {
        headers: { Authorization: token }
      }
    );
